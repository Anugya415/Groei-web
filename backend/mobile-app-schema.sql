...
-- This schema contains only user-facing tables for mobile app access
-- Excludes admin-only tables (admin_settings, analytics)

-- Companies Table
-- Stores company information visible to users
...
-- Users Table
-- Stores user account information (job seekers)
...
-- Jobs Table
-- Stores job postings visible to users
