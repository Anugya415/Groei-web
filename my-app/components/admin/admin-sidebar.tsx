              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#9ca3af]">{adminInfo.role}</p>
                    {adminInfo.company && (
                      <p className="text-xs text-[#6366f1]">{adminInfo.company}</p>
                    )}
                  </div>
                </div>
                <Button
        ...
        <div className="p-6 border-b border-[#2a2a3a]">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-[#1e1e2e] border border-[#2a2a3a]">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[#9ca3af] truncate">{adminInfo.role}</p>
              {adminInfo.company && (
                <p className="text-xs text-[#6366f1] truncate">{adminInfo.company}</p>
              )}
            </div>
          </div>
        </div>
